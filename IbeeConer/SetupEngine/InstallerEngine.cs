...
namespace SetupEngine
{
    ...
    public partial class InstallerEngine : System.Configuration.Install.Installer
    {
...

        {
            ...
            string connStr = "Server=" + serverName + "; Database=" + dbName + ";Trusted_Connection=True;";
...

        {
...

            {
                ...
                ExecuteSql(serverName, "IbeeConer", strScript);

                System.Threading.Thread.Sleep(60 * 1000);

                string connStr = "Server=" + serverName + "; Database= IbeeConer;Trusted_Connection=True;";
...

        {
            ...
            pathApp = assemPath.Substring(0, pos + 1) + "\\IbeeConer.exe.config";
